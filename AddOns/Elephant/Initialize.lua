...
local function SetTabButtonProperties(obj, name, typeInfo)
    ...
    obj:GetNormalTexture():SetVertexColor(ChatTypeInfo[typeInfo].r, ChatTypeInfo[typeInfo].g, ChatTypeInfo[typeInfo].b)
...
function Elephant:OnEnable()
    ...
    SetTabButtonProperties(ElephantFrameGuildTabButton, Elephant.L['chatnames']['guild'], 'GUILD')
    SetTabButtonProperties(ElephantFrameOfficerTabButton, Elephant.L['chatnames']['officer'], 'OFFICER')
    SetTabButtonProperties(ElephantFrameWhisperTabButton, Elephant.L['chatnames']['whisper'], 'WHISPER')
    SetTabButtonProperties(ElephantFramePartyTabButton, Elephant.L['chatnames']['party'], 'PARTY')
    SetTabButtonProperties(ElephantFrameRaidTabButton, Elephant.L['chatnames']['raid'], 'RAID')
    SetTabButtonProperties(ElephantFrameInstanceTabButton, Elephant.L['chatnames']['instance'], 'INSTANCE_CHAT')
    SetTabButtonProperties(ElephantFrameSayTabButton, Elephant.L['chatnames']['say'], 'SAY')
    SetTabButtonProperties(ElephantFrameYellTabButton, Elephant.L['chatnames']['yell'], 'YELL')
