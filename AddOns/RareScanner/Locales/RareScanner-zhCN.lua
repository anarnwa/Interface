...
if AL then
	...
	AL["ALARM_TREASURES_SOUND"] = "事件和包箱提示音"
	...
	AL["DISPLAY_MAP_NOT_DISCOVERED_ICONS_DESC"] = "禁用时未发现的稀有NPC（红色和橙色图标）和宝箱不会在地图上显示"
	AL["DISPLAY_MAP_OLD_NOT_DISCOVERED_ICONS"] = "旧资料片未发现图标显示开关"
	AL["DISPLAY_MAP_OLD_NOT_DISCOVERED_ICONS_DESC"] = "禁用时旧资料片的未发现稀有NPC（红色和橙色图标）和宝箱不会在地图上显示"
	...
	AL["ENABLE_SCAN_ON_TAXI"] = "公交飞行时扫描开关"
	AL["ENABLE_SCAN_ON_TAXI_DESC"] = "启用时当你在使用公交（飞行管理员，船等）时本插件会照常提示"
	...
	AL["ENABLED_SEARCHING_RARE"] = "启用对此NPC的警报："
	AL["EVENT"] = "事件"
	AL["FILTER"] = "NPC过滤"
