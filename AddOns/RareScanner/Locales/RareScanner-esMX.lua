...
if AL then
	...
	AL["MAP_MENU_DISABLE_LAST_SEEN_FILTER"] = "Mostrar NPCs raros vivos incluso si los has visto hace mucho tiempo"
	...
	AL["NOTE_150342"] = "Solo aparece durante el evento [Drill Rig DR-TR35]."
	...
	AL["NOTE_151124"] = "Tienes que obtener un [Smashed Transport Relay] de los enemigos que aparecen durante el evento [Drill Rig DR-JD99] (coordenadas 59.67) y utilizarlo sobre la máquina que hay en la plataforma."
	AL["NOTE_151202"] = "Para invocarle se deben conectar los [Cables] de las orillas, con los [Pilones] que hay dentro del agua."
	AL["NOTE_151308"] = "Solo aparece durante el evento [Drill Rig]."
	AL["NOTE_151569"] = "Se necesita el objeto [Hundred-Fathom Lure] para invocarlo."
	AL["NOTE_151627"] = "Se invoca haciendo uso de un [Exothermic Evaporator Coil] sobre la máquina que hay en la plataforma."
	...
	AL["NOTE_153200"] = "Solo aparece durante el evento [Drill Rig DR-JD41]."
	AL["NOTE_153205"] = "Solo aparece durante el evento [Drill Rig DR-JD99]."
	AL["NOTE_153206"] = "Solo aparece durante el evento [Drill Rig DR-TR28]."
	AL["NOTE_153228"] = "Aparece despues de matar a muchos [Prototipo de centinela] que hay por la zona."
	AL["NOTE_154225"] = "Solo aparece en la interfase a la que se accede utilizando [Personal Time Displacer]. Este objeto se obtiene como recompensa de la misión diaria [The Other Place] que ofrece Chromie."
	AL["NOTE_154701"] = "Solo aparece durante el evento [Drill Rig DR-CC61]."
	AL["NOTE_154739"] = "Solo aparece durante el evento [Drill Rig DR-CC73]."
	...
	AL["NOTE_326408"] = "Esta en una cueva a la que se accede nadando desde el lago que hay justo al sur (coordenadas 74,40)."
