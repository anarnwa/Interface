...
NARCI_SPLASH_HEADER1 = "Equipment Slots";
NARCI_SPLASH_HEADER2 = "Effects";
NARCI_SPLASH_MESSAGE0 = "|cff40C7EB1. The equipment comparison frame has been updated.|r\nYou are now able to view Azerite traits and special effects when comparing items."
NARCI_SPLASH_MESSAGE1 = "|cff40C7EB2. Meet your gem manager -- \"Gemma\"|r\nWhen using Narcissus: If an item has any socket, click the triangle icon and a list of gems will show up. Double-click a gem to socket.\n\nWhen using Blizzard UI: This gem list will pop up with Item Socketing frame.";
...
NARCI_SPLASH_MESSAGE2 = "|cff40C7EB2. New filter: Letterbox effect.|r"
NARCI_SPLASH_MESSAGE3 = "|cff40C7EB1. AFK Screen: Automatically open Narcissus when yo go AFK.|r"
