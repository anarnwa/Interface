...
--> global name declaration
		...
		_detalhes.build_counter = 7152
		_detalhes.alpha_build_counter = 7152 --if this is higher than the regular counter, use it instead
