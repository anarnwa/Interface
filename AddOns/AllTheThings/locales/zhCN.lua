...
AllTheThings.L = {
	...
	-- Instructional Text
	["MINIMAP_MOUSEOVER_TEXT"] = "右键单击以更改设置.\n单击鼠标左键以打开主列表.\nCtrl + 左键单击以打开迷你列表.\nShift + 左键单击刷新集合.";
	["TOP_ROW_INSTRUCTIONS"] = "|cff3399ff左键单击并拖动到移动|r\n|cff3399ff右键单击以打开设置菜单|r\n|cff3399ffShift + 单击以刷新集合|r";
    ["OTHER_ROW_INSTRUCTIONS"] = "|cff3399ffLeft 左键单击以展开/折叠|r\n|cff3399ff右键单击弹出到迷你列表|r\n|cff3399ffShift + 单击以刷新集合|r\n|cff3399ffAlt + 右键单击以在地图标记|r";
	["TOP_ROW_INSTRUCTIONS_AH"] = "|cff3399ff左键单击并拖动到移动|r\n|cff3399ff右键单击以打开设置菜单|r\n|cff3399ffShift + 点击搜索拍卖行|r";
	["OTHER_ROW_INSTRUCTIONS_AH"] = "|cff3399ff左键单击以展开/折叠|r\n|cff3399ff右键单击弹出到迷你列表|r\n|cff3399ffShift + 点击搜索拍卖行|r";
	["RECENTLY_MADE_OBTAINABLE"] = "|CFFFF0000如果最近你有掉落过他 (任何地方除了Salvage\nCrates), 请在Discord中发布你在哪里掉落的!|r";
	["RECENTLY_MADE_OBTAINABLE_PT2"] = "|CFFFF0000信息越多越好.  谢谢!|r";
	["I_ONLY_CARE_ABOUT_MY_MAIN"] = "|cff3399ff我只关心我自己.|r";
	
	-- Binding Localizations
	["TOGGLE_ACCOUNT_MODE"] = "切换战网模式";
	["TOGGLE_COMPLETIONIST_MODE"] = "切换已收集模式";
	["TOGGLE_DEBUG_MODE"] = "切换调试模式";
	["PREFERENCES"] = "喜好";
	["TOGGLE_COMPLETEDTHINGS"] = "切换已收集模式 (两者)";
	["TOGGLE_COMPLETEDGROUPS"] = "切换已收集组";
	["TOGGLE_COLLECTEDTHINGS"] = "切换已收集";
	["TOGGLE_BOEITEMS"] = "切换BoE/BoA项";
	["TOGGLE_SOURCETEXT"] = "切换资源位置";
	["MODULES"] = "模块";
	["TOGGLE_MAINLIST"] = "切换主列表";
	["TOGGLE_MINILIST"] = "切换迷你列表";
	["TOGGLE_PROFESSION_LIST"] = "切换专业列表";
	["TOGGLE_WORLD_QUESTS_LIST"] = "切换世界任务";
	["TOGGLE_RAID_ASSISTANT"] = "切换副本助手";
	["TOGGLE_RANDOM"] = "切换随机";
	["REROLL_RANDOM"] = "重选随机选择";

	-- Event Text
	["ITEM_ID_ADDED"] = "%s (%d) 已经加入你的收藏.";
	["ITEM_ID_ADDED_RANK"] = "%s (%d) [等级 %d] 已经加入你的收藏.";
	["ITEM_ID_ADDED_MISSING"] = "%s (%d) 已经加入你的收藏. 在数据库中找不到. 请向ATT Discord报告!";
	["ITEM_ID_ADDED_SHARED"] = "%s (%d) [+%d] 已经加入你的收藏.";
	["ITEM_ID_ADDED_SHARED_MISSING"] = "%s (%d) [+%d] 已经加入你的收藏";
	["ITEM_ID_REMOVED"] = "%s (%d) 已从你的收藏移除.";
	["ITEM_ID_REMOVED_SHARED"] = "%s (%d) [+%d] 已从你的收藏移除.";
	...
	["COMPLETE"] = "|TInterface\\Addons\\AllTheThings\\assets\\known_green:0|t |cff6dce47完成|r";		-- Acquired the colors and icon from CanIMogIt.
	["INCOMPLETE"] = "|TInterface\\Addons\\AllTheThings\\assets\\unknown:0|t |cffff9333未完成|r";		-- Acquired the colors and icon from CanIMogIt.
	["KNOWN_ON_CHARACTER"] = "|TInterface\\Addons\\AllTheThings\\assets\\known:0|t |cff15abff当前角色已知|r";
	["UNKNOWN_ON_CHARACTER"] = "|TInterface\\Addons\\AllTheThings\\assets\\unknown:0|t |cffff9333当前角色未知|r";
...
-- Lucetia Note: Leave these for now, some may be swapped to achieves instead.
		...
		[-526] = "军团：军团入侵",
		[-527] = "艾泽拉斯之战：荆棘之战",
		[-528] = "破碎海滩",												-- Broken Isles [Mole Machine]
...
-- Custom Subzone Names that we can't pull from the API because Blizz hates us
  -- Val'sharah
	...
	["UNOBTAINABLE_ITEM_REASONS"] = {
		...
		{1, "|CFFFF0000该物品的来源已被删除或从未可供玩家使用.|r", "永远不可用 (1)"}, -- No Hope -- 1
		{1, "|CFFFF0000该物品的来源已被移除.|r", "BoP/BoA(2)"}, -- No Hope -- 2
		{1, "|CFFFF0000这只能在暴雪特别促销或一次性事件中获得.|r", "暴雪推广(3)"}, -- No Hope -- 3
		{1, "|CFFFF0000获得这些奖励所需的成就不再可获得或仅在有限时间内可用.|r", "绝版成就(4)"},	-- Little Hope -- 4
		{2, "|CFFFF0000学习的配方已经被移除.|r", "配方：BoP移除(5)"}, -- Little Hope -- 5
		{2, "|CFFFF0000物品收录在珍藏版,你仍然可以找到但这些在线销售数量非常低.|r", "珍藏版(6)"}, -- Little Hope -- 6
		{3, "|CFFFF0000该物品的来源已被删除,但该项目是绑定装备或可交易宠物.|r", "BoE(7)"}, -- There is Hope -- 7
		{3, "|CFFFF0000学习的食谱已经被移除,物品为装绑.这可以放在拍卖行上.|r", "配方：BoE移除(8)"}, -- There is Hope -- 8
		{3, "|CFFFF0000该物品的来源已被删除,只能与黑市拍卖行.|r", "黑市(9)"}, -- There is Hope -- 9
		{3, "|CFFFF0000从TCG卡的物品不再增加,但仍然可以在线购买,有时黑市也会出现.|r", "刮刮卡(TCG)(10)"}, -- There is Hope -- 10
		{3, "|CFFFF0000绑定在物品上,但如果您有权访问该物品,可以得到BOSS的召唤.|r", "需要召唤物品(11)"}, -- There is Hope -- 11
		{4, "|CFFFF0000原始版本已被删除.|r", "遗留内容(12)"}; -- 12
		{1, "|CFFFF0000版本过高,遗留任务已被删除.|r", "遗留任务(13)"}; -- 13
		{2, "|CFFFF0000这些物品不能购买除非有必要的PVP等级或者在该季度是前 %.|r", "PVP精英/角斗士(14)"}, -- 14
		{1, "|CFFFF0000此物品具有源ID,但显然不能使用并且可能是不可学习的.|r", "未知(15)"}, -- 15
		{2, "|CFFFF0000这些物品需要参加暴雪或购买虚拟门票.你也可以在不同的网站上找到高价格的激活码.|r", "暴雪(16)"},--16
		...
		{16, "|CFF00FFDE亡者节开启.|r", "亡者节(27)"};--27
		{17, "|CFF00FFDE感恩节开启.|r", "感恩节(28)"};--28
		{18, "|CFF00FFDE冬幕节开启.|r", "冬幕节(29)"};--29
		{19, "|CFF00FFDE荆棘钓鱼比赛开启.|r", "荆棘钓鱼比赛(30)"};--30
		{20, "|CFF00FFDE这只能在活跃的魔兽周年纪念日才能获得.未来的周年纪念可能包括这个项目.|r\n", "魔兽周年(31)"};--31
		{4, "|CFFFF0000这是一个原始的香草奖赏(估计老玩家才懂得梗吧).这项任务后来被重新设计并获得了新的奖励.如果你完成了这项任务,很可能这个物品不会被添加到你的衣柜中,因为暴雪会从更新的任务中增加奖励.|r", "经典奖励(32)"};--32
		{4, "|CFFFF0000这个供应商在这个地点或游戏中不再可用.|r", "遗留供应商(33)"}; -- 33
		{4, "|CFFFF0000这个物品是从一个不再能获得的遗留任务中获得的奖励.|r", "遗留任务奖励(34)"}; --34
		{3, "|CFFFF0000氪金就好.|r", "内置商城(35)"}; --35
		{21, "|CFFFF0000这只能在魔兽世界周年纪念日活动时才能获得.不再可用.|r\n", "魔兽周年[绝版](36)"}; -- 36
		{1, "|CFFFF0000这个头衔在游戏中已经无法获得.|r", "头衔(37)"}; --37
		{4, "|CFFFF0000在熊喵人之谜版本中完成橙披任务才能获得|r", "橙披(38)"}; --38
		{4, "|CFFFF0000此标题不再可用.|r", "遗留标题(39)"}; --39
		{4, "|CFFFF0000这是遗留任务或任务用品,不再可用.|r", "遗留任务(40)"}; -- 40
		{4, "|CFFFF0000这些外观仅适用于完成各自法师塔神器挑战并获得基本外观的玩家.|r", "法师塔外观 (41)"}; -- 41
		{21, "|CFFFF0000这些外观仅在每周一次的时光漫游中提供。只有指定时间发布的地下城才可用.|r", "时光漫游 (42)"}; -- 42
		{1, "|CFFFF0000此NPC或人物已从游戏中移除.|r", "删除了的NPC (43)"}; -- 43
		{2, "|CFFFF0000此物品仅在限时供应BMAH.|r", "BMAH限时供应(44)"}; -- 44
		...
		{3, "|CFFFF0000在最高级别下，此物品可能来自入侵.|r", "入侵掉落 (46)"}; -- 46
