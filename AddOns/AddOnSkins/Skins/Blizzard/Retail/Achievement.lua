        ...
        hooksecurefunc(
            ...
            function(self, texture)
                if texture == [[Interface\AchievementFrame\AccountLevel-AchievementHeader]] then
                    Achievement.Backdrop:SetBackdropBorderColor(
                        _G.ACHIEVEMENTUI_BLUEBORDER_R,
                        _G.ACHIEVEMENTUI_BLUEBORDER_G,
                        _G.ACHIEVEMENTUI_BLUEBORDER_B
                    )
                else
...
function AS:SkinAchievementStatusBar(StatusBar)
    ...
    local title, label, text =
        StatusBar.title or _G[StatusBarName .. 'Title'],
        StatusBar.label or _G[StatusBarName .. 'Label'],
        StatusBar.text or _G[StatusBarName .. 'Text']
...
function AS:Blizzard_AchievementUI(event, addon)
    ...
    _G.AchievementFrameAchievementsContainer.Backdrop:SetPoint(
        'TOPLEFT',
        _G.AchievementFrameAchievementsContainer,
        'TOPLEFT',
        -2,
        1
    )
    ...
    _G.AchievementFrameComparisonContainer.Backdrop:SetPoint(
        'TOPLEFT',
        _G.AchievementFrameComparisonContainer,
        'TOPLEFT',
        -2,
        1
    )
    ...
    for i = 1, 12 do
        ...
        _G[StatusBar .. 'Button']:HookScript(
            'OnEnter',
            function(self)
                _G[StatusBar].Backdrop:SetBackdropBorderColor(1, .8, .1)
            end
        )
        _G[StatusBar .. 'Button']:HookScript(
            'OnLeave',
            function(self)
                _G[StatusBar].Backdrop:SetBackdropBorderColor(unpack(AS.BorderColor))
            end
        )
    end
